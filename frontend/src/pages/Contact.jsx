  ...
  `}
      ...
      <div className="w-full text-center mt-20 px-4">
        ...
        <p className="text-gray-700 mt-4 leading-relaxed max-w-3xl mx-auto text-[15px]">
          For inquiries and further information, please don't hesitate to get in
          touch with any one of our resorts. We will be happy to hear from you!
        </p>
      </div>
      {/* ---------------------------- DIRECTIONS + MAP ---------------------------- */}
      ...
      <div className="w-full max-w-[1400px] mx-auto mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 px-6">
        ...
        <div
          ref={formRef}
          className="bg-white border border-gray-300 p-6 text-base"
        >
          <h3 className="text-2xl font-medium mb-6 tracking-wide">
