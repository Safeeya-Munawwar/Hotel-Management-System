    ...
    <div className="font-poppins bg-white text-[#222]">
      ...
      <div className="relative w-full h-[400px] md:h-[560px] overflow-hidden">
        ...
        >
          <h2 className="text-2xl leading-snug text-right mr-4">
            Let Us Give Your Dream Day <br />A New Wing...
          </h2>
      ...
      <div className="w-full text-center mt-10 px-4">
        ...
        <p className="text-gray-700 mt-6 leading-relaxed max-w-3xl mx-auto text-[15px]">
          Our four banquet halls — Grand Ballroom, Crown Court, Windsor
          Ballroom, and LAVO — are the perfect venues to host your wedding. Our
          chefs will delight your guests with a selection of Western and Asian
          cuisine.
        </p>
      </div>
        ...
        <div className="bg-white p-6 shadow overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="flex flex-col justify-center items-start p-8 text-left">
              ...
              <p className="text-gray-700 leading-relaxed mb-8">
                Spacious and modern, the wedding halls are the ideal backdrop to
                make your special day magical. Whether you are having an indoor
                or a traditional wedding, the architecture and interior of our
                banquet halls will perfectly complement your theme. The
                breathtaking views of the surrounding landscape are ideal to
                host an outdoor wedding. With the impressive infinity pool area,
                lobby with elaborate carvings and other picturesque locations,
                The Golden Crown, Kandy will provide glamorous backgrounds for
                your photos. The banquet hall layout you have in mind will
                surely add glamour to the event.
              </p>
